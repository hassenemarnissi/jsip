...
public class LogWriter implements StackLogger
{
    ...
    public void setStackProperties(Properties configurationProperties)
    {
        ...
        // logger name.
        String category = configurationProperties.getProperty(
                "gov.nist.javax.sip.LOG4J_LOGGER_NAME", this.stackName);
                    ...
                    if (this.needsLogging && this.logFileName != null)
                    {
                        ...
                        boolean overwrite = Boolean
                                .valueOf(configurationProperties
                                        .getProperty("gov.nist.javax.sip.DEBUG_LOG_OVERWRITE"));
    ...
    public void logTrace(String message)
    {
        if (needsLogging)
        {
            ...
            if (this.lineCount == 0)
            {
                ...
                getLogger().debug(
                        "Config Propeties = " + this.configurationProperties);
            }
